...
export function DashboardPage() {
  ...
  if (error) {
    return (
      <div className="card p-6 border-danger-border bg-danger-bg text-danger">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="card p-5 lg:col-span-2">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-semibold text-neutral-160">{t("dashboard.byStatus")}</h3>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
            {STATUS_ORDER.map((s) => (
              <Link
                ...
                className="rounded border border-neutral-40 hover:border-brand-400 hover:bg-brand-50 p-3 text-center transition-colors"
              >
                <div className="text-xs font-semibold text-neutral-130">
                  {t(`status.${s}`)}
                </div>
                <div className="mt-1 text-xl font-semibold text-neutral-190">
        ...
        <div className="card p-5">
          <h3 className="text-sm font-semibold text-neutral-160 mb-4">
            {t("dashboard.syncHealth")}
          </h3>
          <div className="space-y-3 text-sm">
            <div className="flex items-center justify-between">
              <span className="text-neutral-130">{t("dashboard.recentFailures")}</span>
              <span
            ...
            <div className="flex items-center justify-between">
              <span className="text-neutral-130">{t("dashboard.syncedDocuments")}</span>
              <span className="font-semibold text-neutral-190">
