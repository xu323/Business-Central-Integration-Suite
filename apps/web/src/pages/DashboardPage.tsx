...
const STATUS_ORDER = ["Draft", "Submitted", "Approved", "Rejected", "Synced"];
    ...
    <div className="space-y-6">
      <div className="flex items-end justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">
            Procurement & approval pipeline at a glance.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="card p-5">
          <h3 className="text-sm font-semibold text-slate-700 mb-4">Sync Health</h3>
          <div className="space-y-3 text-sm">
            <div className="flex items-center justify-between">
              <span className="text-slate-600">Recent failures (7d)</span>
              <span
            ...
            <div className="flex items-center justify-between">
              <span className="text-slate-600">Synced documents</span>
